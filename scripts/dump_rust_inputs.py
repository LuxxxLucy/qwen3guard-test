...
from bench_common import load_representative_texts  # noqa: E402
from contract import TEMPLATES  # noqa: E402
from backends import PyTorchCPUBackend  # noqa: E402
...
def main() -> int:
    ...
    ap.add_argument("--out", default="src/backends/rust/bench_inputs.json")
    args = ap.parse_args()
