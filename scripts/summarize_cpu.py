...
Scans var/results/, prints a method x template latency pivot to stdout, and
writes var/results/REPORT_CPU_GEN_AUTO.md.
"""
...
from contract import OPT_LEVELS, RUNTIMES, TEMPLATES  # noqa: E402

# (runtime, precision, opt_level) -> (backend_label, variant_label).
# Backend label appears only on the first row of each backend block.
# "(L2 baked)" annotates the first row of backends that bake lastpos into
# export; continuation rows drop it.
ROWS: list[tuple[tuple[str, str, str], tuple[str, str]]] = [
    ...
    (("pytorch",     "fp32", "L3"), ("",                  "+L3 prefix-KV")),
    (("onnx",        "fp32", "L0"), ("onnx fp32", "L0")),
    (("onnx",        "fp32", "L1"), ("",          "+L1 forced-prefix")),
    (("onnx",        "fp32", "L2"), ("",          "+L2 lastpos")),
    (("onnx",        "fp32", "L3"), ("",          "+L3 prefix-KV")),
    (("onnx",        "int8", "L0"), ("onnx int8", "L0")),
    (("onnx",        "int8", "L1"), ("",          "+L1 forced-prefix")),
    (("onnx",        "int8", "L2"), ("",          "+L2 lastpos")),
    (("onnx",        "int8", "L3"), ("",          "+L3 prefix-KV")),
    (("llamacpp",    "f32",  "L0"), ("llamacpp f32",      "L0 (L2 baked)")),
    (("llamacpp",    "f32",  "L1"), ("",                  "+L1 forced-prefix")),
    (("llamacpp",    "f32",  "L3"), ("",                  "+L3 prefix-KV")),
    (("llamacpp",    "f32-kopt", "L0"), ("llamacpp f32 +kernel-opt", "L0 (L2 baked)")),
    (("llamacpp",    "f32-kopt", "L1"), ("",                         "+L1 forced-prefix")),
    (("llamacpp",    "f32-kopt", "L3"), ("",                         "+L3 prefix-KV")),
    (("llamacpp",    "f16",  "L0"), ("llamacpp f16",      "L0 (L2 baked)")),
    (("llamacpp",    "f16",  "L1"), ("",                  "+L1 forced-prefix")),
    (("llamacpp",    "f16",  "L3"), ("",                  "+L3 prefix-KV")),
    (("llamacpp",    "q8_0", "L0"), ("llamacpp q8_0",     "L0 (L2 baked)")),
    (("llamacpp",    "q8_0", "L1"), ("",                  "+L1 forced-prefix")),
    ...
    (("ctranslate2", "fp32", "L0"), ("ctranslate2 fp32",  "L0 (L2 baked)")),
    (("ctranslate2", "fp32", "L1"), ("",                  "+L1 forced-prefix")),
    (("mnn",         "fp16", "L0"), ("mnn-llm fp16",      "L0 (L2 baked)")),
    (("mnn",         "fp16", "L1"), ("",                  "+L1 forced-prefix")),
    (("vllm-cpu",    "fp32", "L1"), ("vllm-cpu fp32",     "L0 (L1 L2 L3 baked)")),
]
...
def main() -> int:
    results_dir = Path(sys.argv[1]) if len(sys.argv) > 1 else Path("var/results")
    ...
    report = Path("var/results/REPORT_CPU_GEN_AUTO.md")
