...
10. **Kunpeng 925 port.** Cross-arch checks: ONNX Runtime aarch64 wheel, OpenVINO ARM maturity, llama.cpp NEON / SVE, Rust candle on aarch64. → verify: same script runs; numbers populate the same table.
